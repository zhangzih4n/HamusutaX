...
import hamusutax.core.formats.bittorrent.BitTorrent.Companion.BLOCK_SIZE
...
fun Source.encodeToBitTorrentCompatibility(
    ...
    while (true) {
        ...
        if (blocksV2.size != blocksPerPiece) {
            ...
            val leavesRequired = if (piecesV2.isEmpty()) blocksV2.size.nextPowerOf(2) else pieceLength
