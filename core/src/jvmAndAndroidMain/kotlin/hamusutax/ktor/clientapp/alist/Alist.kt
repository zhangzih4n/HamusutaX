package hamusutax.ktor.clientapp.alist

import hamusutax.ktor.clientapp.alist.utils.checkCode
import hamusutax.core.io.path.extension
import hamusutax.core.io.path.readByteArray
import hamusutax.ktor.client.httpclient.ignoreAllSslErrorsTrustManager
import hamusutax.ktor.clientapp.alist.model.payload.*
import hamusutax.ktor.clientapp.alist.model.response.*
...
class Alist(
    ...
    private val client: HttpClient = HttpClient(CIO) {
        engine {
            ...
            https {
                trustManager = ignoreAllSslErrorsTrustManager
            }
        }
        defaultRequest {
            headers {
    ...
    suspend fun download(path: String, sign: String): ByteReadChannel {
        ...
        response.headers["Content-Disposition"] ?: run {
            ...
            throw hamusutax.ktor.clientapp.alist.utils.AlistException()
        }
    ...
    suspend fun fsRemoveEmptyDirectory(srcDir: String) =
        fsRemoveEmptyDirectory(FsRemoveEmptyDirectoryPayload(srcDir))
