...
package hamusutax.formats

import hamusutax.datetime.isValidDate
import hamusutax.formats.Gender.FEMALE
import hamusutax.formats.Gender.MALE
import hamusutax.io.encoding.mod11_2
import kotlinx.datetime.LocalDate

private class IdentificationNumber(private val number: String) {
    init {
    ...
    val gender = if (number[16].digitToInt() % 2 == 0) FEMALE else MALE
